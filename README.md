...
<img alt="A 45 second demo in Claude Code: install atelier, run the doctor, ask for social cards, change the brand background and regenerate, audit a page for runtime UX problems and fix them, and watch CI go green." src="demos/overview.webp" width="100%">
